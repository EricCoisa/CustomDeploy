...
namespace CustomDeploy.Migrations
{
    ...
    [Migration("20250807191006_InitialCreate")]
            ...
            modelBuilder.Entity("CustomDeploy.Models.Entities.AcessoNivel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CriadoEm = new DateTime(2025, 8, 7, 19, 10, 6, 398, DateTimeKind.Utc).AddTicks(994),
                            Nome = "Administrador"
                        },
                        new
                        {
                            Id = 2,
                            CriadoEm = new DateTime(2025, 8, 7, 19, 10, 6, 398, DateTimeKind.Utc).AddTicks(996),
                            Nome = "Operador"
                        });
                });
